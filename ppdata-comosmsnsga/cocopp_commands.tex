...
\providecommand{\cocoversion}{{\scriptsize\sffamily{}\color{Gray}Data produced with COCO v2.4.19, hv-hash=ff0e71e8cd978373}}
\providecommand{\numofalgs}{3}
...
\providecommand{\algCtables}{\StrLeft{SMS-EMOA-DE Auger bbob-biobj}{\ntables}}
\providecommand{\algBtables}{\StrLeft{NSGA-II-MATLAB Auger bbob-biobj}{\ntables}}
\providecommand{\algAtables}{\StrLeft{COMO-100 dufosse bbob-biobj}{\ntables}}
\providecommand{\ntables}{4}
\providecommand{\pptablesfooter}{
\end{tabularx}
}
...
\providecommand{\bbobpptablesmanylegend}[1]{%
        ...
        evaluations) divided by the respective best \ERT\ measured during BBOB-2016 in
        #1.
